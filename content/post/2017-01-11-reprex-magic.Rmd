...
<img src="https://njtierney.updog.co/img/reprex-run.gif" alt="Gif of reprex copying code, running reprex, and demonstrating the html preview of the code text" style="width: 100%;max-height: 100%" />
</div>
</p>
...
<p>
<div style="height: auto">
<img src="https://njtierney.updog.co/img/reprex-github.gif" alt="Gif of reprex copying code, running reprex, and demonstrating the html preview of the code text" style="width: 100%;max-height: 100%" />
</div>
</p>
...
<p>
<div style="height: auto">
<img src="https://njtierney.updog.co/img/reprex-fail-1.gif" alt="Gif of reprex copying code, running reprex, and demonstrating the html preview of the code text" style="width: 100%;max-height: 100%" />
</div>
</p>
...
<p>
<div style="height: auto">
<img src="https://njtierney.updog.co/img/reprex-success-1.gif" alt="Gif of reprex copying code, running reprex, and demonstrating the html preview of the code text using visdat, naniar, and ggplot2 packages" style="width: 100%;max-height: 100%" />
</div>
</p>
...
<p>
<div style="height: auto">
<img src="https://njtierney.updog.co/img/reprex-si.gif" alt="Gif of reprex copying code, running reprex, showing option SI = TRUE" style="width: 100%;max-height: 100%" />
</div>
</p>
