...
We also discussed how [`pagedown`]() provides a fresh approach to generating PDF on the web, and were lucky to have the creator of [paged.js]() (which powers `pagedown`) [Adam Hyde]() in our call.
...
Some suggestions on addressing this were (I think?):
...
Ultimately, this is a hard problem to solve, and mimics a real life pen and paper notebook. [Roger Peng]() discussed an approach to this in [NSSDeviations]() (around episode 74 I think?), involving a manual approach
