...
This can be combined with the `protan()`, `deutan()`, and `tritan()` functions to simulate a particular type of CVD. Let's wrap this up into a function to return the colour palettes as a list.
