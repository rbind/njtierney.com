...
- **Teaching**: Building on my experience as a university lecturer in data analysis and business analytics at Monash University. You can see my current training offerings at [training.njtierney.com](https://training.njtierney.com). These courses cover the following topics: [R Best Practices](https://r-best-practices.njtierney.com/), [Introduction to Quarto (aka "Quarto for Scientists")](https://qmd4sci.njtierney.com/), [Making Better Graphics](https://better-vis.njtierney.com/), [Introduction to Functions and Debugging](https://fun2debug.njtierney.com/), [Introduction to Git and GitHub](https://gentle-git.njtierney.com/), [Using targets and geotargets](https://gentle-targets.njtierney.com/), [Introduction to R package development](https://intro2rpkgs.njtierney.com/). I can also deliver courses on Using the tidyverse, data analytics, and exploratory data analysis.
